    ...
    return (
        <PageLayout title={t('auth.changeTitle')} backTo="/profile">
            ...
            <div className="form-stack" style={{ top: 285 }}>
                ...
                <RoundButton width={620} height={104} type={1} content={t('auth.changeTitle')} disabled={!isPassword(currentPassword) || !isPassword(newPassword)} onClick={() => setMessage(t('auth.changeUnavailable'))} style={{ justifySelf: 'center' }}/>
